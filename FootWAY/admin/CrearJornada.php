  ...
  <div class="collapse navbar-collapse" >
    ...
    <li class="nav-item">
      <a class="nav-link" href="CrearPartit.php">Crear Partit</a>
       ...
       <li class="nav-item">
      <a class="nav-link active" href="CrearJornada.php">Crear Jornada</a>
    </li>
    <li class="nav-item">
...
<ul class="navbar-nav mr-auto">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" placeholder="Entra la data de naixement" name="dataInici" required>
      </div>
        
      <div class="form-group">
        <label for="dataFi">Data Final:</label>
        <input type="date" class="form-control" placeholder="Entra la data de naixement" name="dataFi" required>
      </div>
        
   
     <center> <button type="submit" class="btn btn-primary">Afegir</button></center>
</form>
    </div>
